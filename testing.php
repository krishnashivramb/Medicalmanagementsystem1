    ...
    <div id="main">
      ...
      <div id="menu">
        ...
        <ul>
          ...
          <li><a href="bill.php">GenerateBill</a></li>
        ...
        <div class="col-md-9">
          <form method="POST" action="search.php">
            ...
            <div class="input-group mb-3">
              <input type="text" name="searchInput" class="form-control" placeholder="search product by name ..." aria-label="Recipient's username" aria-describedby="button-addon2">
              <div class="input-group-append">
                <input type="submit" name="searchProduct" class="btn btn-outline-primary" id="button-addon2" value="Search">
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="batchNo" class="form-control" value="<?PHP echo $batchNo ?>" disabled>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      <input type="text" name="mrp" value="<?PHP echo $mrp ?>" class="form-control">
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer">
                ...
                <button type="submit" class="btn btn-block btn-primary up-btn" name="update">Update</button>
              </div>
            </div>
          </form>
